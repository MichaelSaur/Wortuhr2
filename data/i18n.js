const translations = {
    de: {
        ...
        ntpServerPlaceholder: "pool.ntp.org",
        ntpServerInvalid: "Ungültiger NTP-Server (gültiger Hostname erforderlich)",
        ntpSynced: "Mit NTP synchronisiert",
        ntpNotSynced: "Nicht mit NTP synchronisiert",
        cardColors: "Farben",
    ...
    en: {
        ...
        ntpServerLabel: "NTP server",
        ntpServerPlaceholder: "pool.ntp.org",
        ntpServerInvalid: "Invalid NTP server (must be a valid hostname)",
        ntpSynced: "Synchronized with NTP",
        ntpNotSynced: "Not synchronized with NTP",
        cardColors: "Colors",
